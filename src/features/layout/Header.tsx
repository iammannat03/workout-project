...
import { LogIn, UserPlus, LogOut, User, Crown } from "lucide-react";
        ...
        <div className="navbar-start flex items-center gap-2">
          ...
          >
            ...
            <div className="flex-col hidden sm:flex">
              <span className="font-bold transition-colors duration-200 group-hover:text-blue-400">Fitness DB</span>
            </div>
          </Link>
        </div>
