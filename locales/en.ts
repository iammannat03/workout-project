export default {
  ...
  workout_builder: {
    ...
    categories: {
      title: "Browse Workout Categories",
      description: "Choose a category to explore exercises for that equipment type",
      exercises: "Exercises",
      exercises_found: "exercises found",
      no_exercises: "No exercises found for this category.",
    },
    navigation: {
      previous: "Previous",
      continue: "Continue",
